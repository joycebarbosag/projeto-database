...
CREATE TABLE escolas_schema.sala (
    ...
    fk_id_espaco INTEGER,
    FOREIGN KEY (fk_id_tipo_sala) REFERENCES escolas_schema.tipos_salas (id_tipo_sala),
    FOREIGN KEY (fk_id_espaco) REFERENCES escolas_schema.espaco (id_espaco)
);
...
CREATE TABLE escolas_schema.escola (
    ...
    FOREIGN KEY (fk_id_estado) REFERENCES escolas_schema.estado (id_estado),
    FOREIGN KEY (fk_id_diferenciamento) REFERENCES escolas_schema.diferenciamento (id_diferenciamento),
    FOREIGN KEY (fk_id_orgao) REFERENCES escolas_schema.orgao (id_orgao),
    FOREIGN KEY (fk_id_cidade) REFERENCES escolas_schema.cidade (id_cidade),
    FOREIGN KEY (fk_id_tipo_escola) REFERENCES escolas_schema.tipo_escola (id_tipo_escola),
    FOREIGN KEY (fk_id_tipo_localizacao) REFERENCES escolas_schema.tipo_localizacao (id_tipo_localizacao),
    FOREIGN KEY (fk_id_espaco) REFERENCES escolas_schema.espaco (id_espaco),
    FOREIGN KEY (fk_id_escola_referenciada) REFERENCES escolas_schema.escola (id_escola)
);